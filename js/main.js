/* variables */
let citylist = ['Москва', 'Фрязино', 'Актау', 'Магадан', 'Санкт-Петербург', 'Севастополь', 'Ярославль', 'Вологда', 'Владивосток', 'Барнаул', 'Петрозаводск', 'Самара', 'Саратов', 'Тверь', 'Ростов-на-Дону', 'Париж', 'Пермь', 'Екатеринбург', 'Новосибирск', 'Калининград'];
let rangemin = 0;
let rangemax = 300000;
let startbasket = [
    {
